function addWidgetsfrmFitToParent() {
    frmFitToParent.setDefaultUnit(kony.flex.DP);
    ...
    var segHamburgerMenu = new kony.ui.SegmentedUI2({
        "id": "segHamburgerMenu",
        "onRowClick": AS_Segment_e0f622775003438596dd4e0e8f98d7b5,
        "scrollingEvents": {},
...
function frmFitToParentGlobals() {
    frmFitToParent = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmFitToParent,
        "enabledForIdleTimeout": false,
        "id": "frmFitToParent",
        "init": AS_Form_dfbae9b48d4441c7ae4785c060fa203b,
        "layoutType": kony.flex.FREE_FORM,
        "needAppMenu": false,
        "skin": "sknFrm1"
    }, {
