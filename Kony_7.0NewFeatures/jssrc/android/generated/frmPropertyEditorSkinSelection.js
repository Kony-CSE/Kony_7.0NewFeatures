function addWidgetsfrmPropertyEditorSkinSelection() {
    frmPropertyEditorSkinSelection.setDefaultUnit(kony.flex.DP);
    ...
    var segHamburgerMenu = new kony.ui.SegmentedUI2({
        "id": "segHamburgerMenu",
        "onRowClick": AS_Segment_6fea44ee50fd4903b8f1eca57ed426ee,
        "scrollingEvents": {},
    ...
    frmPropertyEditorSkinSelection.add(
    flexHamburgerMenu, flexMainContent);
};

function frmPropertyEditorSkinSelectionGlobals() {
    frmPropertyEditorSkinSelection = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmPropertyEditorSkinSelection,
        "enabledForIdleTimeout": false,
        "id": "frmPropertyEditorSkinSelection",
        "init": AS_Form_18f3486e75924965a78a764db07f9fa8,
        "layoutType": kony.flex.FREE_FORM,
        "needAppMenu": false,
        "skin": "sknFrm1"
    }, {
