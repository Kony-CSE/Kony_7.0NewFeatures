function addWidgetsfrmi18KeysImportExport() {
    frmi18KeysImportExport.setDefaultUnit(kony.flex.DP);
    ...
    var segHamburgerMenu = new kony.ui.SegmentedUI2({
        "id": "segHamburgerMenu",
        "onRowClick": AS_Segment_222615d4c4e240c78635d83cbc2fb19b,
        "scrollingEvents": {},
    ...
    frmi18KeysImportExport.add(
    flexHamburgerMenu, flexMainContent);
};

function frmi18KeysImportExportGlobals() {
    frmi18KeysImportExport = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmi18KeysImportExport,
        "enabledForIdleTimeout": false,
        "id": "frmi18KeysImportExport",
        "init": AS_Form_ea6eb3be78b9455084151c57af650705,
        "layoutType": kony.flex.FREE_FORM,
        "needAppMenu": false,
        "skin": "sknFrm1"
    }, {
