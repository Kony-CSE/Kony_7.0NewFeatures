function addWidgetsfrmUndoRedoInViz() {
    frmUndoRedoInViz.setDefaultUnit(kony.flex.DP);
    ...
    var segHamburgerMenu = new kony.ui.SegmentedUI2({
        "id": "segHamburgerMenu",
        "onRowClick": AS_Segment_a47225dee2e448dfa4b99cafba895929,
        "scrollingEvents": {},
    ...
    frmUndoRedoInViz.add(
    flexHamburgerMenu, flexMainContent);
};

function frmUndoRedoInVizGlobals() {
    frmUndoRedoInViz = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmUndoRedoInViz,
        "enabledForIdleTimeout": false,
        "id": "frmUndoRedoInViz",
        "layoutType": kony.flex.FREE_FORM,
        "needAppMenu": false,
        "preShow": AS_Form_958f2f9a65c64be38828415ebf387937,
        "skin": "sknFrm1"
    }, {
