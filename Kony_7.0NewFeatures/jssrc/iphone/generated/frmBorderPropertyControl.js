function addWidgetsfrmBorderPropertyControl() {
    frmBorderPropertyControl.setDefaultUnit(kony.flex.DP);
    ...
    var segHamburgerMenu = new kony.ui.SegmentedUI2({
        "id": "segHamburgerMenu",
        "onRowClick": AS_Segment_04bfeac4b5e74ba880c687b256116e85,
        "scrollingEvents": {},
    ...
    frmBorderPropertyControl.add(
    flexHamburgerMenu, flexMainContent);
};

function frmBorderPropertyControlGlobals() {
    frmBorderPropertyControl = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmBorderPropertyControl,
        "enabledForIdleTimeout": false,
        "id": "frmBorderPropertyControl",
        "init": AS_Form_57d9b68262b9457db274f4661c5708b9,
        "layoutType": kony.flex.FREE_FORM,
        "needAppMenu": false,
        "skin": "sknFrm1"
    }, {
