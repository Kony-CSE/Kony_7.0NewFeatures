function addWidgetsfrmAppCanvasFocus() {
    frmAppCanvasFocus.setDefaultUnit(kony.flex.DP);
    ...
    var segHamburgerMenu = new kony.ui.SegmentedUI2({
        "id": "segHamburgerMenu",
        "onRowClick": AS_Segment_baa46cb5f9884fde9ef8892d56467e63,
        "scrollingEvents": {},
    ...
    frmAppCanvasFocus.add(
    flexHamburgerMenu, flexMainContent);
};

function frmAppCanvasFocusGlobals() {
    frmAppCanvasFocus = new kony.ui.Form2({
        "addWidgets": addWidgetsfrmAppCanvasFocus,
        "enabledForIdleTimeout": false,
        "id": "frmAppCanvasFocus",
        "init": AS_Form_b84304ed8dca4d12af6491338988ddd8,
        "layoutType": kony.flex.FREE_FORM,
        "needAppMenu": false,
        "skin": "sknFrm1"
    }, {
