...
function callbackAnimation() {
    ...
    var rowList = [row1];
    frmSegment.segCategories.animateRows({
        rows: rowList,
        widgets: ["lblProductPrice"],
...
function launchCamAndCaptureVideo(camera) {
    ...
    alert(camera);
    frmCamera.videoWiget.source = {
        "rawBytes": frmCamera.cam.rawBytes
    };
